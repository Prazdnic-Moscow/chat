...
template <> constexpr inline auto secondwindow::qt_create_metaobjectdata<qt_meta_tag_ZN12secondwindowE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "secondwindow",
        "on_savedchange_clicked",
        "",
        "on_openfile_clicked",
        "on_radioButton3_clicked",
        "on_createFile_clicked"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'on_savedchange_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_openfile_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_radioButton3_clicked'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_createFile_clicked'
...
void secondwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_savedchange_clicked(); break;
        case 1: _t->on_openfile_clicked(); break;
        case 2: _t->on_radioButton3_clicked(); break;
        case 3: _t->on_createFile_clicked(); break;
        default: ;
        }
    }
    (void)_a;
