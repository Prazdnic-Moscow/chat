...
namespace {
struct qt_meta_tag_ZN11thirdwindowE_t {};
} // unnamed namespace

template <> constexpr inline auto thirdwindow::qt_create_metaobjectdata<qt_meta_tag_ZN11thirdwindowE_t>()
{
    ...
    return QtMocHelpers::metaObjectData<thirdwindow, qt_meta_tag_ZN11thirdwindowE_t>(QMC::MetaObjectFlag{}, qt_stringData,
            qt_methods, qt_properties, qt_enums);
}
Q_CONSTINIT const QMetaObject thirdwindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11thirdwindowE_t>.stringdata,
    qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11thirdwindowE_t>.data,
    qt_static_metacall,
    nullptr,
    qt_staticMetaObjectRelocatingContent<qt_meta_tag_ZN11thirdwindowE_t>.metaTypes,
    nullptr
} };
...
void *thirdwindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_staticMetaObjectStaticContent<qt_meta_tag_ZN11thirdwindowE_t>.strings))
